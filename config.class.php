...
class Config {
    ...
    public static $webAppVersion = "20191214";  //Used to load the actual css und js files.
    public static $SupportedLang = array("en"); //First language ist the default language.
